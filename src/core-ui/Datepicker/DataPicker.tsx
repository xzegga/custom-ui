...
import { DatePickerAria, DateValue, useDatePicker } from 'react-aria';
...
export function DatePicker(props: DatePickerStateOptions<DateValue>) {
  ...
  const {
    ...
    dialogProps,
    calendarProps,
  }: DatePickerAria = useDatePicker(props, state, ref);
