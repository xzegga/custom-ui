  ...
  return (
    <>
      ...
      <h2 className="mt-12 mb-2 font-bold text-xl text-left">Breadcrumbs</h2>
        ...
        <br />
        <Button styling={'rounded bg-primary-900 text-white hover:bg-primary-800'} onPress={()=>alert('Hello :)')}>Primary Btn</Button>
        <br />
        <br />
        <Button styling={'border border-secondary-900 rounded text-secondary-900 bg-white hover:bg-secondary-900 hover:text-white'} onPress={()=>alert('Hello :)')}>Secondary Btn</Button>
        <br />
        <br />
        <Button styling={'rounded bg-danger-900 text-white hover:bg-danger-800'} onPress={()=>alert('Hello :)')}>Danger Btn</Button>
        <br />
        <br />
        <Button styling={'rounded bg-warning-900 text-white hover:bg-warning-800'} onPress={()=>alert('Hello :)')}>Warning Btn</Button>
        <br />
        <br />
        <Button styling={'border border-primary-900 rounded text-primary-900 bg-white hover:bg-primary-900 hover:text-white'} onPress={()=>alert('Hello :)')}>Primary Reverse Btn</Button>
        <br />
        <br />
        <Button styling={'border border-danger-900 rounded text-danger-900 bg-white hover:bg-danger-900 hover:text-white'} onPress={()=>alert('Hello :)')}>Danger Reverse Btn</Button>
        <br />
        <br />
        <Button styling={'border border-warning-900 rounded text-warning-900 bg-white hover:bg-warning-900 hover:text-white'} onPress={()=>alert('Hello :)')}>Warning Reverse Btn</Button>
      </div>
    </>
  );
}
